...
from safety_gymnasium.assets.geoms import Hazards, Sigwalls
...
class GoalLevel0(BaseTask):
    ...
    def __init__(self, config) -> None:
        ...
        self._add_geoms(Goal(keepout=0.305, size=0.15))
        self._add_geoms(Hazards(num=num_hazards, keepout=0.18))
        self._add_geoms(Sigwalls(num=2, locate_factor=1.5))
